  ...
  if (input) {
    ...
    while (!input.eof()) {
      if (STRING.find("Function Trace :") != string::npos) {
        ...
        int val;
        i = 0;
        /* Time : 1469765080178357 Pid : 15029 Tid : 15038 Function Trace :
         * Setattr */
        while (i < 13) {
          ss >> temp;
          if (i == 5) { /* Pid */
        ...
        /* Time : 1479359116150960 Pid : 1134 Tid : 1191 Read inode :
         * 139934933593136 off : 0 size : 16384 diff : 7306689 */
        stringstream ss;
        ss << STRING;
        string temp;
        int val;
